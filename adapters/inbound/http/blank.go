...
func (BlankHandler) BooksList(w http.ResponseWriter, r *http.Request, params BooksListParams) {
	notImplemented(w, r)
}
...
func (BlankHandler) ElectronicGamesList(w http.ResponseWriter, r *http.Request, params ElectronicGamesListParams) {
	notImplemented(w, r)
}
...
// (GET /movies)
func (BlankHandler) MoviesList(w http.ResponseWriter, r *http.Request, params MoviesListParams) {
	notImplemented(w, r)
}
...
func (BlankHandler) NonElectronicGamesList(w http.ResponseWriter, r *http.Request, params NonElectronicGamesListParams) {
	notImplemented(w, r)
}
...
// (GET /tv-series)
func (BlankHandler) TVSeriesList(w http.ResponseWriter, r *http.Request, params TVSeriesListParams) {
	notImplemented(w, r)
}
